...
class CanvasTest extends AnyFlatSpec with Matchers {
  ...
  it should "not have ships in adjacent cells" in {
    val firstShip = canvas.updateCanvas(start = (10, 7), end = (10, 10), canvas = canvas.drawCanvas)
    val secondShip = canvas.updateCanvas(start = (9, 8), end = (9, 10), canvas = firstShip)
    val thirdShip = canvas.updateCanvas(start = (1, 1), end = (3, 1), canvas = secondShip)
