...
class ShipTest extends AnyFlatSpec with Matchers {
  ...
  it should "not have ships in adjacent cells" in {
    val firstShip = new Ship(startX = 10, startY = 7, endX = 10, endY = 10, canvas = canvas.drawCanvas).updateLocation()
    val secondShip = new Ship(startX = 9, startY = 8, endX = 9, endY = 10, canvas = firstShip).updateLocation()
    val result = new Ship(startX = 1, startY = 1, endX = 3, endY = 1, canvas = secondShip).updateLocation()
